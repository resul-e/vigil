...
pub const STRINGS: &[Entry] = &[
    ...
    Entry { key: "menu.mode_split",           tr: "Mod: split:1 (Türk Telekom)", en: "Mode: split:1 (Türk Telekom)" },
    Entry { key: "menu.mode_tlsrec",          tr: "Mod: tlsrec:64 (Superonline)", en: "Mode: tlsrec:64 (Superonline)" },
